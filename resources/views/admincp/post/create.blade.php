                ...
                <div class="card-body">
                    ...
                    <form autocomplete="off" method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="summary" id="ckeditor_summary" cols="50" rows="10" placeholder="Tóm tắt....."></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nội dung</label> <br>
                            <textarea name="content" id="ckeditor_content" cols="50" rows="10" placeholder="Nội dung....."></textarea>
                        </div>
                        <div class="form-group">
